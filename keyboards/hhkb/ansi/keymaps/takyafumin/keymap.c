...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    ...
    */
    ...
    [BASE] = LAYOUT( //  default layer
        ...
        CT_TAB,   CTL_A,    KC_S,    KC_D,   F_VIM,    KC_G,    KC_H,   J_VIM,    KC_K,      KC_L, CTLSCLN,     CT_QUOT,  KC_ENT,
        KC_RSFT,   KC_Z,    KC_X,    KC_C,    KC_V,    KC_B,    KC_N,    KC_M,    KC_COMM, KC_DOT, KC_SLSH,     KC_LSFT, MO(HHKB),
        KC_LGUI,  L2_EXT,/*              */ SFT_SPC,  L1_EXT, KC_RALT
    ),
    ...
    [VIM] = LAYOUT(
        ...
        XXXXXXX,  KC_ESC, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX,
        XXXXXXX, XXXXXXX, KC_HOME, XXXXXXX,  KC_END, XXXXXXX, KC_LEFT, KC_DOWN, KC_UP,   KC_RGHT, KC_APP,  XXXXXXX, XXXXXXX,
    ...
    [EXT] = LAYOUT(
        ...
        XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, KC_PSCR, XXXXXXX, XXXXXXX, XXXXXXX,
         CT_TAB,  CT_TAB, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, KC_LEFT, KC_DOWN, KC_UP,   KC_RGHT, KC_ENT , XXXXXXX, XXXXXXX,
        XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, KC_HOME, KC_PGUP, KC_PGDN, KC_END , XXXXXXX, XXXXXXX, XXXXXXX,
