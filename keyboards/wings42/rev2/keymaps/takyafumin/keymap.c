...
#define ALTQUOT  RALT_T(KC_QUOT)
#define GUILBRC  RGUI_T(KC_LBRC)
// right home mods key
...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    ...
    //|--------+--------+--------+--------+--------+--------|                     |--------+--------+--------+--------+--------+--------|
        _______, CTLTAB , ALTQUOT, GUILBRC, KC_RBRC, KC_BSLS,                       KC_LEFT, KC_DOWN, KC_UP  ,KC_RIGHT, KC_COLN, EE_CLR ,
    //|--------+--------+--------+--------+--------+--------|                     |--------+--------+--------+--------+--------+--------|
        _______, KC_LSFT, KC_DQT , KC_LCBR, KC_RCBR, KC_PIPE,                       KC_EQL , KC_MINS, KC_LT  , KC_GT  , KC_QUES, QK_BOOT,
    //`--------+--------+--------+--------+--------+--------/                     \--------+--------+--------+--------+--------+--------'
                                  _______, _______, KC_LSFT ,                        S_BS   , EXTENT , DEL
    //                          `+--------+--------+--------'                      `--------+-------+--------+'
    ),
    ...
    //|--------+--------+--------+--------+--------+--------|                     |--------+--------+--------+--------+--------+--------|
        _______, KC_GRV , KC_QUOT, KC_LBRC, KC_RBRC, KC_BSLS,                       XXXXXXX, XXXXXXX, KC_RGUI, KC_RALT, CTLQUOT, _______,
    //|--------+--------+--------+--------+--------+--------|                     |--------+--------+--------+--------+--------+--------|
    ...
    //|--------+--------+--------+--------+--------+--------|                     |--------+--------+--------+--------+--------+--------|
        _______, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX,                       KC_F11 , KC_F12 , XXXXXXX, XXXXXXX, KC_MENU, _______,
    //`--------+--------+--------+--------+--------+--------/                     \--------+--------+--------+--------+--------+--------'
        ...
        case L1_EN:
            if (record->event.pressed) {
                ...
                if (l2_state.is_tap_hold) {
                    ...
                    tap_code(EN);
                    l2_state.tap_count++;
                    wait_ms(200); // 200ms以内に連続タップがなければタップカウントをリセット
